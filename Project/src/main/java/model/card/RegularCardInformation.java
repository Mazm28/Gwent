...
public enum RegularCardInformation implements Serializable {
    ...
    VIDKAARL("Vidkaarl", 14, 0, "Close", ActionController.MoralBoost(), false, Faction.SKELLIGE, "/IMAGES/sm/skellige_vildkaarl.png"),
    ...
    DONAR_AN_HINDAR("Donar an Hindar", 4, 1, "Close", null, false, Faction.SKELLIGE, "/IMAGES/sm/skellige_donar.png"),
    CLAN_AN_CRAITE("Clan An Craite", 6,3, "Close", ActionController.TightBond(), false, Faction.SKELLIGE, "/IMAGES/sm/skellige_crach_an_craite.png"),
    BLUEBOY_LUGOS("Blueboy Lugos", 6, 1, "Close", null, false, Faction.SKELLIGE, "/IMAGES/sm/skellige_blueboy.png"),
    MADMAN_LUGOS("Madman Lugos", 6,1,"Close", null, false,Faction.SKELLIGE, "/IMAGES/sm/skellige_madmad_lugos.png"),
    CERYS("Cerys", 10,1,"Close", ActionController.Muster(), true, Faction.SKELLIGE, "/IMAGES/sm/skellige_cerys.png"),
    KAMBI("Kambi", 11,1,"Close", ActionController.Transformers(), true, Faction.SKELLIGE, "/IMAGES/sm/skellige_kambi.png"),
    BIRNA_BRAN("Birna Bran", 2,1,"Close", ActionController.Medic(), false, Faction.SKELLIGE, "/IMAGES/sm/skellige_birna.png"),
    CLAN_Drummond_Shieldmaiden("Clan Drummond Shieldmaiden", 4,3,"Close", ActionController.TightBond(), false, Faction.SKELLIGE, "/IMAGES/sm/skellige_shield_maiden.png"),
    CLAN_TORDARROCH_ARMORSMITH("Clan Tordarroch Armorsmith", 4,1,"Close", null, false, Faction.SKELLIGE, "/IMAGES/sm/skellige_shield_maiden_1.png"),
    CLAN_DIMUN_PIRATE("Clan Dimun Pirate", 6,1,"Ranged", ActionController.Scorch(), false, Faction.SKELLIGE, "/IMAGES/sm/skellige_dimun_pirate.png"),
    CLAN_BROKVAR_ARCHER("Clan Brokvar Archer", 6,3, "Ranged", null , false, Faction.SKELLIGE, "/IMAGES/sm/nilfgaard_black_archer_1.png"),
    ERMION("Ermion", 8,1,"Ranged", ActionController.Mardroeme(), true, Faction.SKELLIGE, "/IMAGES/sm/skellige_ermion.png"),
    HJALMAR("Hjalmar", 10,1,"Ranged", null, true, Faction.SKELLIGE, "/IMAGES/sm/skellige_hjalmar.png"),
    YOUNG_BERSERKER("Young Berserker", 2,3, "Ranged", ActionController.Berserker(), false, Faction.SKELLIGE, "/IMAGES/sm/skellige_young_berserker.png"),
    YOUNG_VIDKAARL("Young Vidkaarl", 8, 0,"Ranged", ActionController.TightBond(), false, Faction.SKELLIGE, "/IMAGES/sm/skellige_young_vildkaarl.png"),
    LIGHT_LONGSHIP("Light Longship", 4,3,"Ranged", ActionController.Muster(), false, Faction.SKELLIGE, "/IMAGES/sm/skellige_light_longship.png"),
    HOLGER_BLACKHAND("Holger Blackhand", 4,1,"Siege", null, false, Faction.SKELLIGE, "/IMAGES/sm/skellige_holger.png"),
    WAR_LONGSHIP("War Longship", 6,3, "Siege", ActionController.TightBond(), false, Faction.SKELLIGE, "/IMAGES/sm/skellige_war_longship.png"),
    DRAIG_BON_DHU("Draig Bon-Dhu", 2,1,"Siege", ActionController.CommanderHorn(), false, Faction.SKELLIGE, "/IMAGES/sm/skellige_draig.png"),
    OLAF("Olaf", 12,1,"Agile", ActionController.MoralBoost(), false, Faction.SKELLIGE, "/IMAGES/sm/skellige_olaf.png")
    ;
    final String name;
    final int power;
