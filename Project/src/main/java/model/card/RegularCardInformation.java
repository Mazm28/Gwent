...
public enum RegularCardInformation implements Serializable {
    ...
    VIDKAARL("Vidkaarl", 14, 0, "Close", ActionController.MoralBoost(), false, Faction.SKELLIGE, "/IMAGES/lg/skellige_vildkaarl.jpg"),
    ...
    YOUNG_VIDKAARL("Young Vidkaarl", 8, 0, "Ranged", ActionController.TightBond(), false, Faction.SKELLIGE, "/IMAGES/lg/skellige_young_vildkaarl.jpg"),
    ...
    ELVEN_SKIRMISHER("Elven Skirmisher", 2, 3, "Ranged", ActionController.Muster(), false, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_elf_skirmisher.jpg"),
    IORVETH("Iorveth", 10, 1, "Ranged", null, true, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_iorveth.jpg"),
    YAEVINN("Yaevinn", 6, 1, "Agile", null, false, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_yaevinn.jpg"),
    CIARAN_AEP("Ciaran aep", 3, 1, "Agile", null, false, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_ciaran.jpg"),
    DENNIS_CRANMER("Dennis Cranmer", 6, 1, "Close", null, false, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_dennis.jpg"),
    DOL_BLATHANNA_SCOUT("Dol Blathanna Scout", 6, 3, "Agile", null, false, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_dol_infantry.jpg"),
    DOL_BLATHANNA_ARCHER("Dol Blathanna Archer", 4, 1, "Ranged", null, false, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_dol_archer.jpg"),
    DWARVEN_SKIRMISHER("Dwarven Skirmisher", 3, 3, "Close", ActionController.Muster(), false, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_dwarf.jpg"),
    FILAVANDREL("Filavandrel", 6, 3, "Agile", null, false, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_filavandrel.jpg"),
    HAVEKAR_HEALER("Havekar Healer", 0, 3, "Ranged", ActionController.Medic(), false, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_havekar_nurse.jpg"),
    IDA_EMEAN_AEP("Ida Emean aep", 6, 1, "Ranged", null, false, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_ida.jpg"),
    HAVEKAR_SMUGGLER("Havekar Smuggler", 5, 3, "Close", ActionController.Muster(), false, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_havekar_support.jpg"),
    RIORDAIN("Riordain", 1, 1, "Ranged", null, false, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_riordain.jpg"),
    ISENGRIM_FAOILTIARNA("Isengrim Faoiltiarna", 10, 1, "Close", ActionController.MoralBoost(), true, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_isengrim.jpg"),
    EITHNE("Eithne", 10, 1, "Ranged", null, true, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_eithne.jpg"),
    BARCLAY_ELS("Barclay Els", 6, 1, "Agile", null, false, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_barclay.jpg"),
    SCHIRRU("Schirru", 8, 1, "Siege", ActionController.Scorch(), false, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_schirru.jpg"),
    SEASENTHESSIS("Seasenthessis", 10, 1, "Ranged", null, true, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_saskia.jpg"),
    MILVA("Milva", 10, 1, "Ranged", ActionController.MoralBoost(), false, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_milva.jpg"),
    VRIHEDD_BRIGADE_VETERAN("Vrihedd Brigade Veteran", 5, 2, "Agile", null, false, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_vrihedd_brigade.jpg"),
    MAHAKAMAN_DEFENDER("Mahakaman Defender", 5, 5, "Close", null, false, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_mahakam.jpg"),
    VRIHEDD_BRIGADE_RECRUIT("Vrihedd Brigade Recruit", 4, 1, "Ranged", null, false, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_vrihedd_cadet.jpg"),
    TORUVIEL("Toruviel", 10, 1, "Ranged", null, false, Faction.SCOIATAEL, "/IMAGES/lg/scoiatael_toruviel.jpg");
    final String name;
    final int power;
